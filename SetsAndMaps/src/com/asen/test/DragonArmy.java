...
import java.util.Scanner;
    ...
    public class DragonArmy {
        public static void main(String[] args) {
            ...
            types.
                    forEach((key, value) -> {
                        double ar = sumMiddle(value, "armor");
                        double dmg = sumMiddle(value, "damage");
                        double health = sumMiddle(value, "health");
                        System.out.println(String.format("%s::(%.2f/%.2f/%.2f)", key, dmg, health, ar));
                        value.
                                entrySet().
                                stream().
